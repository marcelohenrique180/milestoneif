...
},{"./Link":"../node_modules/@hyperapp/router/src/Link.js","./Route":"../node_modules/@hyperapp/router/src/Route.js","./Switch":"../node_modules/@hyperapp/router/src/Switch.js","./Redirect":"../node_modules/@hyperapp/router/src/Redirect.js","./location":"../node_modules/@hyperapp/router/src/location.js"}],"../src/store.ts":[function(require,module,exports) {
'use strict';
...
(function (Store) {
    ...
    Store.actions = {
        ...
        register: function register(username, pass) {
            return function (state) {
                localStorage.setItem('username', username);
                return { logged: { isLoggedIn: true } };
            };
        ...
        logout: function logout() {
            return function (state) {
                return { logged: { isLoggedIn: false } };
            };
        }
    };
})(Store || (exports.Store = Store = {}));
},{"@hyperapp/router":"../node_modules/@hyperapp/router/src/index.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../src/components/navbar/style.scss":[function(require,module,exports) {

var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/components/navbar/index.tsx":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.NavbarComponent = exports.Logo = undefined;
...
var Logo = exports.Logo = function Logo() {
    return (0, _hyperapp.h)("img", { src: "https://github.com/paulasevero/outfit-perfeito/raw/master/assets/logotxt.png" });
};
var NavbarComponent = exports.NavbarComponent = function NavbarComponent(_ref) {
    var isLoggedIn = _ref.logged.isLoggedIn;
    return (0, _hyperapp.h)("nav", { className: "nav" }, (0, _hyperapp.h)(_router.Link, { to: "/register" }, "Registrar-se"), (0, _hyperapp.h)(Logo, null), isLoggedIn ? (0, _hyperapp.h)(_router.Link, { to: "/logout" }, "Logout") : (0, _hyperapp.h)(_router.Link, { to: "/login" }, "Login"));
};
},{"hyperapp":"../node_modules/hyperapp/src/index.js","@hyperapp/router":"../node_modules/@hyperapp/router/src/index.js","./style.scss":"../src/components/navbar/style.scss"}],"../src/styles/style.scss":[function(require,module,exports) {
...
exports.view = exports.actions = exports.state = undefined;

var _hyperapp = require("hyperapp");

var _router = require("@hyperapp/router");

var _store = require("./store.ts");

var _index = require("./components/navbar/index.tsx");

require("./styles/style.scss");

var state = exports.state = _store.Store.state;
var actions = exports.actions = _store.Store.actions;
var Home = function Home() {
    return (0, _hyperapp.h)("h2", null, "Home");
};
var Login = function Login() {
    return (0, _hyperapp.h)("h2", null, "Login");
};
var view = exports.view = function view(state, actions) {
    return (0, _hyperapp.h)("main", null, (0, _hyperapp.h)(_index.NavbarComponent, Object.assign({}, state)), (0, _hyperapp.h)(_router.Switch, null, (0, _hyperapp.h)(_router.Route, { path: "/", render: Home }), (0, _hyperapp.h)(_router.Route, { path: "/login", render: Login })));
};
},{"hyperapp":"../node_modules/hyperapp/src/index.js","@hyperapp/router":"../node_modules/@hyperapp/router/src/index.js","./store.ts":"../src/store.ts","./components/navbar/index.tsx":"../src/components/navbar/index.tsx","./styles/style.scss":"../src/styles/style.scss"}],"../src/main.tsx":[function(require,module,exports) {
"use strict";
...
var main = (0, _hyperapp.app)(_app.state, _app.actions, _app.view, document.body);
var unsubscribe = _router.location.subscribe(main.location);
},{"hyperapp":"../node_modules/hyperapp/src/index.js","@hyperapp/router":"../node_modules/@hyperapp/router/src/index.js","./app.tsx":"../src/app.tsx"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/main.9a6e69b6.map